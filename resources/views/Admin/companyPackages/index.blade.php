...
@php
    $route = 'companyPackages';
@endphp
@section('title',__('lang.companyPackages'))
@section('header')
    <!--begin::Heading-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table  align-middle table-row-bordered  text-center fs-4 gy-5" id="users_table">
                        ...
                        <tr class="bg-secondary text-dark  fw-bolder fs-5 text-capitalize gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.is_sale')}}</th>
                            <th class="min-w-125px">{{__('lang.sale_percent')}}</th>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            columns: [
                ...
                {data: 'is_sale', name: 'is_sale', "searchable": true, "orderable": true},
                {data: 'sale_percent', name: 'sale_percent', "searchable": true, "orderable": true},
                {data: 'total_ads', name: 'total_ads', "searchable": true, "orderable": true},
