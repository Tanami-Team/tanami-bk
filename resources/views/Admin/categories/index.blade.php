...
@php
    $route = 'categories';
@endphp
@section('title',__('lang.main_categories'))
@section('header')
    <!--begin::Heading-->
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table  align-middle table-row-bordered  text-center fs-4 gy-5" id="users_table">
                            ...
                            <th class="min-w-125px">{{__('lang.sub_categories')}}</th>
        ...
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'type', name: 'status', "searchable": true, "orderable": true},
                    {data: 'status', name: 'status', "searchable": true, "orderable": true},
                    {data: 'sub_categories', name: 'sub_categories', "searchable": true, "orderable": true},
