...
@php
    $route = 'question-comments';
@endphp
@section('title',__('lang.question-comments'))
@section('header')
    <!--begin::Heading-->
    ...
    <ul class="breadcrumb fw-bold fs-base my-1">
        ...
        <li class="breadcrumb-item">
            <a href="{{url('/questions')}}" class="text-muted">
                {{trans('lang.Questions')}} </a>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table  align-middle table-row-bordered  text-center fs-4 gy-5" id="users_table">
                        ...
                        <tr class="bg-secondary text-dark  fw-bolder fs-5 text-capitalize gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.comment')}}</th>
                            <th class="min-w-125px">{{__('lang.question')}}</th>
                            <th class="min-w-125px">{{__('lang.UserName')}}</th>
                            <th class="min-w-125px">{{__('lang.view_count')}}</th>
                        </tr>
                        <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
        ...
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'question', name: 'question', "searchable": false, "orderable": true},
                    {data: 'user_name', name: 'user_name', "searchable": false, "orderable": true},
                    {data: 'view_count', name: 'view_count', "searchable": false, "orderable": false},
                ]
            });
            $.ajax({
