...
@endphp
@section('title',__('lang.CompanySubscriptions'))
@section('header')
    <!--begin::Heading-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table  align-middle table-row-bordered  text-center fs-4 gy-5" id="users_table">
                        ...
                        <tr class="bg-secondary text-dark  fw-bolder fs-5 text-capitalize gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.company')}}</th>
                            <th class="min-w-125px">{{__('lang.status')}}</th>
                            <th class="min-w-125px">{{__('lang.package_type')}}</th>
                            <th class="min-w-125px">{{__('lang.expire_date')}}</th>
                            <th class="min-w-125px">{{__('lang.price')}}</th>
                            <th class="min-w-125px">{{__('lang.total_ads')}}</th>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            columns: [
                ...
                {data: 'package_type', name: 'package_type', "searchable": true, "orderable": true},
                {data: 'expiration_date', name: 'expiration_date', "searchable": true, "orderable": true},
                {data: 'package_price', name: 'price', "searchable": true, "orderable": true},
                {data: 'package_total_ads', name: 'total_ads', "searchable": true, "orderable": true},
