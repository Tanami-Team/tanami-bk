...
<body id="kt_body" style="background-image: url()"
      class="header-fixed header-tablet-and-mobile-fixed aside-fixed @if(Request::is('host') || Request::is('host/setting')) aside-secondary-disabled @else aside-secondary-enabled  @endif">
<!--begin::Main-->
<!--begin::Root-->
                    ...
                    <div class="hover-scroll-y mb-10" data-kt-scroll="true"
                        ...
                        <!--end::Nav item-->
                            ...
                            <li class="nav-item mb-2 togge" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                ...
                                <!--begin::Nav link-->
                                <a class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light  @if( request()->segment(2) == 'employees' || request()->segment(2) == 'news' || request()->segment(2) == 'surveys' || request()->segment(2) == 'surveyquestions' ) active @endif  "
                            ...
                            <li class="nav-item mb-2 togge" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                ...
                                <!--begin::Nav link-->
                                <a class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light @if(request()->segment(2) == 'events' || request()->segment(2) == 'speakers'|| request()->segment(2) == 'sponsors' || request()->segment(2) == 'event-agenda' || request()->segment(2) == 'eventsRequests' || request()->segment(2) == 'customfields' || request()->segment(2) == 'customfieldanswers' || request()->segment(2) == 'exhibitors'  || request()->segment(2) == 'tickets'  || request()->segment(2) == 'partners'  ) active @endif "
                                ...
                                @if(\App\Models\EventRequest::where('type','pending')->count() > 0)
                                    <span class="badge badge-light-danger">{{\App\Models\EventRequest::where('type','pending')->count()}}</span>
                            @endif
                                <!--end::Nav link-->
                            </li>
{{--                            <li class="nav-item mb-2 togge" data-bs-toggle="tooltip" data-bs-trigger="hover"--}}
                ...
                <div class="aside-workspace my-5 p-5" id="kt_aside_wordspace">
                    <div class="d-flex h-100 flex-column">
                        ...
                        <div class="flex-column-fluid hover-scroll-y" data-kt-scroll="true"
                            ...
                            @include('layout.host.sidebars.basic_menus')
                            @include('layout.host.sidebars.events_menus')
                            <!--end::Menu-->
            ...
            <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
                ...
                <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                    ...
                    <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
                        ...
                        <!--begin::Logo-->
                        <a href="{{url('/host')}}" class="d-flex align-items-center">
