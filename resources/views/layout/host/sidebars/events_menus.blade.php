...
@if(request()->segment(2) == 'events' || request()->segment(2) == 'speakers'|| request()->segment(2) == 'sponsors' || request()->segment(2) == 'event-agenda' || request()->segment(2) == 'eventsRequests' || request()->segment(2) == 'customfields' || request()->segment(2) == 'customfieldanswers' || request()->segment(2) == 'exhibitors'  || request()->segment(2) == 'tickets'  || request()->segment(2) == 'partners'  ) active show @endif
    ...
    <div
        ...
        <div id="kt_aside_menu_wrapper" class="menu-fit">
            ...
            <div class="menu-item">
                <a class="menu-link @if(request()->routeIs('host.events.*')) active @endif "
                   href="{{url('host/events')}}">
<span class="menu-icon">
    ...
    <!--end::Svg Icon-->
            ...
            <div class="menu-item">
                <a class="menu-link @if(request()->routeIs('host.eventsRequests.*')) active @endif "
                   href="{{url('host/eventsRequests')}}">
                     <span class="menu-icon">
            ...
            <div class="menu-item">
                <a class="menu-link @if(request()->routeIs('host.customfields.*') || request()->routeIs('host.customfieldanswers.*')) active @endif "
                   href="{{url('host/customfields')}}">
<span class="menu-icon">
    ...
    <!--end::Svg Icon-->
            ...
            <div class="menu-item">
                <a class="menu-link @if(request()->routeIs('host.tickets.*')) active @endif "
                   href="{{url('host/tickets')}}">
                     <span class="menu-icon">
            ...
            <div class="menu-item">
                <a class="menu-link @if(request()->routeIs('host.speakers.*')) active @endif "
                   href="{{url('host/speakers')}}">
<span class="menu-icon">
    ...
    <!--end::Svg Icon-->
            ...
            <div class="menu-item">
                <a class="menu-link @if(request()->routeIs('host.partners.*')) active @endif "
                   href="{{url('host/partners')}}">
                       <span class="menu-icon">
            ...
            <div class="menu-item">
                <a class="menu-link @if(request()->routeIs('host.sponsors.*')) active @endif "
                   href="{{url('host/sponsors')}}">
                        <span class="menu-icon">
            ...
            <div class="menu-item">
                <a class="menu-link @if(request()->routeIs('host.exhibitors.*')) active @endif "
                   href="{{url('host/exhibitors')}}">
                     <span class="menu-icon">
